...
// pg. 6 "Round Phases" and pg. 10 "Boss Fights". The Henchmen Side and Boss Side share the
// same 8 round phases; only the Enemy Roll Phase (and, on the Boss Side, Boss Defense during Target &
...
export const MISSION_HENCHMEN_PHASES: MissionPhase[] = [
  {
    name: 'Pass Phase',
    subtitle: 'Pass the Start Player Token clockwise at the start of every round.',
    body: 'Pass the Start Player Token clockwise to the next Hero. This player becomes the new Start Player until the end of the round. Whenever you resolve something "in turn order," begin with the Start Player and continue clockwise. This phase is skipped on the very first round of the Henchmen Side.',
    callout: 'This is the only phase skipped on Round 1 of the Henchmen Side — every other round runs the full 8-phase sequence.',
    bullets: ['Token passes clockwise every round.', 'Skipped only on Round 1 of the Henchmen Side.', 'Turn order for the rest of the round starts with the new Start Player.'],
  },
  {
    name: 'Movement Phase',
  ...
  },
  {
    ...
    callout: 'A single dice roll can match multiple Henchman types at once — all of them activate off that one roll, not just the first match. (This is the opposite of how the Boss works on the Boss Side — see that phase for the difference.)',
  ...
  },
  {
    ...
    callout: "This is the same Crisis Clock mechanic on both sides of a Mission — it doesn't reset between the Henchmen Side and the Boss Side unless a specific Mission says otherwise.",
...
export const MISSION_BOSS_PHASES: MissionPhase[] = [
  {
    name: 'Pass Phase',
    subtitle: 'Pass the Start Player Token clockwise at the start of every round.',
    ...
    callout: "Unlike the Henchmen Side, this phase is NOT skipped on the first round of the Boss Side — the Pass Phase skip only ever applies to the Henchmen Side's very first round.",
    bullets: ["Token passes clockwise every round, including the Boss Side's first round.", 'Turn order for the rest of the round starts with the new Start Player.'],
  },
  {
    name: 'Movement Phase',
    subtitle: 'All Heroes move simultaneously and collect Boost Tiles.',
    body: 'All Hero pawns move at the same time. You may move any number of spaces, including zero. You cannot move onto or through a space with a dark inset background unless it is covered by a Defeat Tile. You can move through (or swap with) other Heroes, but two Heroes cannot end the phase on the same space — if there is a dispute, the Hero earlier in turn order chooses. Collect any Boost Tiles on the space where you end your move.',
    callout: 'On the Boss Side, some Boost Tiles you collect will be face-down — these come from the Boss\'s Enemy Roll Phase and stay on your Health Dial until after the Boss\'s next Attack.',
  ...
  },
  {
    ...
    callout: 'Income Phase is skipped by every Hero on the very first round of the Boss Side too, not just the Henchmen Side.',
  ...
  },
  {
    ...
    callout: 'The Crisis Clock carries over from the Henchmen Side — it does not reset when you flip to the Boss Side unless a specific Mission says otherwise.',
